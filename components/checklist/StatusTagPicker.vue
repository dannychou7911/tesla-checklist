...
<template>
  ...
  >
    <button
      ...
      class="flex-1 min-h-[44px] px-3 py-2 rounded-xl border text-sm font-medium transition-all cursor-pointer active:scale-[0.98] flex items-center justify-center gap-1.5"
